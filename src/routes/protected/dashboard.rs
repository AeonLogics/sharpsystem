        ...
        <div class="dashboard-container">
                ...
                <Suspense fallback=move || {
                    view! {
                        <div class="card glass-card p-6 border border-white/5 flex items-center justify-center">
                            <InlineLoader
                                size_class="size-base"
                                loading_text="Syncing Core...".to_string()
                            />
                        </div>
                    }
                }>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a
                        href="/system/pos"
                        class="group relative overflow-hidden rounded-[var(--radius-lg)] p-6 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-hover)] border border-white/10 shadow-premium transition-all hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(139,92,246,0.3)]"
                    >
                    ...
                    <a
                        ...
                        class="group relative overflow-hidden rounded-[var(--radius-lg)] p-6 bg-[var(--bg-elevated)] border border-[var(--border-default)] hover:border-[var(--color-primary)]/50 transition-all shadow-sm hover:-translate-y-1 hover:shadow-md"
                    >
                        <div class="relative z-10 flex flex-col gap-3">
                            ...
                            <h3 class="text-lg font-bold text-[var(--text-primary)] group-hover:text-[var(--color-primary)] transition-colors">
                                "Receive Stock"
                            </h3>
                            <p class="text-sm text-[var(--text-secondary)]">
                                "Scan or bulk add items"
                            </p>
                        </div>
                    </a>
